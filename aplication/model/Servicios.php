...
class Servicios{
	...
	{
		//$sql   = "SELECT * FROM servicios_ubicacion INNER JOIN servicios USING(id_servicio) WHERE id_departamento IN ($departamentos) GROUP BY id_servicio ORDER BY id_departamento asc";
