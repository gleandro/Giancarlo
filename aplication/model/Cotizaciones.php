...
class Cotizaciones{
	...
	{
		$sql   = "SELECT * FROM cotizaciones_paquetes_itinerarios_detalles WHERE id_cotizacion_paquete_itinerario= '".$id."' ";
	...
	{
		$sql   = "SELECT * FROM cotizaciones_paquetes_itinerarios_detalles WHERE id_paquete_itinerario= '".$id."' ";
		$query = new Consulta($sql);
		$datos = array();
	...
	static public function getCotizacionesItinerariosServicios($id)
	{
		$sql   = "SELECT * FROM cotizaciones_paquetes_itinerarios_detalles INNER JOIN servicios USING(id_servicio) WHERE id_paquete_itinerario= '".$id."' ";
		$query = new Consulta($sql);
		$datos = array();
...
*/
	public function getHotelesxItinerario($id){
			$sql = "SELECT * FROM cotizaciones_paquetes_itinerarios_hoteles WHERE id_cotizacion_paquete_itinerario = '".$id."' " ;
	...
	static public function getCotizacionesHotelesxHabitaciones($id){
			$sql = "SELECT * FROM cotizaciones_paquetes_itinerarios_hoteles_detalles WHERE id_cotizacion_paquete_itinerario_hotel = '".$id."' " ;
