...
! function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        showRefresh: false,
        showAddButton: false,
        showAddButtonServicio: false,
        showAddButtonTipoServicio: false,
        showAddButtonHabitacion: false,
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES['en'] = {
        ...
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('Mostrando %s al %s de %s filas', pageFrom, pageTo, totalRows);
        },
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        // showColumns, showToggle, showRefresh, showAddButton
        html = [sprintf('<div class="columns columns-%s pull-%s">',
            this.options.buttonsAlign, this.options.buttonsAlign, this.options.urlAddButton)];
        ...
        if (this.options.showAddButtonTipoServicio) {
            html.push(sprintf('<button onclick="addTipoServicios()'+'" class="btn btn-success' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="plus" title="%s">',
                    this.options.formatAddButton()),
                sprintf('<i class="fa fa-plus"></i>'),
                '</button>');
        }

        if (this.options.showAddButtonHabitacion) {
            html.push(sprintf('<button onclick="addHabitaciones()'+'" class="btn btn-success' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="plus" title="%s">',
                    this.options.formatAddButton()),
                sprintf('<i class="fa fa-plus"></i>'),
                '</button>');
        }

        if (this.options.showAddButtonDepartamento) {
            html.push(sprintf('<button onclick="addDepartamentos()'+'" class="btn btn-success' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="plus" title="%s">',
                    this.options.formatAddButton()),
                sprintf('<i class="fa fa-plus"></i>'),
                '</button>');
        }

        if (this.options.showAddButtonHotel) {
            html.push(sprintf('<button onclick="addHotel()'+'" class="btn btn-success' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="plus" title="%s">',
                    this.options.formatAddButton()),
                sprintf('<i class="fa fa-plus"></i>'),
                '</button>');
        }
        ...
        if (this.options.showAddButton) {
            html.push(sprintf('<button onclick="addEmpresa()'+'" class="btn btn-success' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="plus" title="%s">',
                    this.options.formatAddButton()),
                sprintf('<i class="fa fa-plus"></i>'),
                '</button>');
        }

        if (this.options.showAddButtonServicio) {
            html.push(sprintf('<button onclick="addServicio()'+'" class="btn btn-success' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="plus" title="%s">',
                    this.options.formatAddButton()),
                sprintf('<i class="fa fa-plus"></i>'),
                '</button>');
        }

        if (this.options.showAddButtonPaquete) {
            html.push(sprintf('<button onclick="addPaquete()'+'" class="btn btn-success' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="plus" title="%s">',
                    this.options.formatAddButton()),
                sprintf('<i class="fa fa-plus"></i>'),
                '</button>');
        }
        ...
        if (this.options.showAddButtonAgencia) {
            html.push(sprintf('<button onclick="addAgencias()'+'" class="btn btn-success' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="plus" title="%s">',
                    this.options.formatAddButton()),
                sprintf('<i class="fa fa-plus"></i>'),
                '</button>');
        }
        ...
        if (this.options.showPlus) {
            this.$toolbar.find('button[name="plus"]')
                .off('click').on('click', $.proxy(this.plus, this));
        }
    ...
    BootstrapTable.prototype.addOptions = function (options) {
        //If the objects are equivalent then avoid the call of destroy / init methods
        if (compareObjects(this.options, options, false)) {
            return;
        }
