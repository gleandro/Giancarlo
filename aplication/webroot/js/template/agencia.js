var $table = $('#bootstrap-table-agencia');
  ...
  $().ready(function(){
      window.operateEvents = {
          'click .money': function (e, value, row, index) {
              ...
              location.href="agencias.php?action=rate&id="+row.id;
              console.log(info);
          },
          ...
          'click .edit': function (e, value, row, index) {
              ...
              location.href="agencias.php?action=edit&id="+row.id;
          },
          'click .remove': function (e, value, row, index) {
              swal({
                  ...
                  $.ajax({
                    type : "GET",
                    url :"ajax.php",
                    data: "&action=borrarAgencia&id="+row.id,
                    beforeSend: function(){
                    },
                    success: function(datos){
                      swal(
...
function addAgencias() {
    location.href="agencias.php?action=add";
}
