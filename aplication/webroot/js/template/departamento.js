...
var $tableTipo = $('#bootstrap-table-departamentos');
...
$().ready(function(){
        ...
        'click .edit': function (e, value, row, index) {
            ...
            swal({
              ...
              $.ajax({
                type : "GET",
                url :"ajax.php",
                data: "&action=cambiarDepartamento&id="+row.id+"&nombre="+result,
                beforeSend: function(){
                },
        ...
        'click .remove': function (e, value, row, index) {
            ...
            swal({
              ...
              $.ajax({
                type : "GET",
                url :"ajax.php",
                data: "&action=borrarDepartamento&id="+row.id,
                beforeSend: function(){
                },
                success: function(datos){
                  swal(
    ...
    $tableTipo.bootstrapTable({
        ...
        showToggle: true,
        showColumns: true,
        showAddButtonDepartamento: true,
        pagination: true,
        searchAlign: 'left',
        pageSize: 8,
        clickToSelect: false,
        ...
        formatRecordsPerPage: function(pageNumber){
            return pageNumber + " Filas Visible";
        },
        icons: {
            add: 'fa fa-plus',
...
function addDepartamentos() {
    location.href="departamentos.php?action=add";
}

$("#formAddDepartamento").submit(function(e) {
    e.preventDefault();
    ...
    /*alert($("#formAddDepartamento").serialize()+'&action=registrarDepartamento');*/

    $.ajax({
        type : "GET",
        url :"ajax.php",
        data: $("#formAddDepartamento").serialize()+'&action=registrarDepartamento',
        beforeSend: function(){
