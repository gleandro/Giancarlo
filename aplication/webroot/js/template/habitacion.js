var $table = $('#bootstrap-table-habitaciones');
...
$("#formAddHabitacion").submit(function(e) {
    e.preventDefault();
    var $form = $(this);
    if(! $form.valid()) return false;
    var formData = new FormData($("#formAddHabitacion")[0]);
    var ruta = "ajax2.php";
    $.ajax({
        url: ruta,
        type: "POST",
...
$("#formEditHabitacion").submit(function(e) {
    e.preventDefault();
    ...
    var formData = new FormData($("#formEditHabitacion")[0]);
    var ruta = "ajax2.php";
  ...
  $().ready(function(){
      window.operateEvents = {
          ...
          'click .edit': function (e, value, row, index) {
              ...
              location.href="habitaciones.php?action=edit&id="+row.id;
          },
          'click .remove': function (e, value, row, index) {
              swal({
                  ...
                  $.ajax({
                    type : "GET",
                    url :"ajax.php",
                    data: "&action=borrarHabitacion&id="+row.id,
                    beforeSend: function(){
                    },
                    success: function(datos){
                      swal(
...
function addHabitaciones() {
    location.href="habitaciones.php?action=add";
}
