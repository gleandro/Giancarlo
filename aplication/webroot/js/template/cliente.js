var $table = $('#bootstrap-table-cliente');
...
$("#formAddCliente").submit(function(e) { //AGREGAR UN PAQUETE
    e.preventDefault();
    var $form = $(this);
    ...
    if ($('#list_sedes').length > 0) {
      ...
      window.operateEvents = {
          'click .edit': function (e, value, row, index) {
              ...
              location.href="clientes.php?action=edit&id="+row.id;
          },
          'click .remove': function (e, value, row, index) {
              swal({
                  ...
                  $.ajax({
                    type : "GET",
                    url :"ajax.php",
                    data: "&action=borrarCliente&id="+row.id,
                    beforeSend: function(){
                    },
                    success: function(datos){
                      swal(
...
function addClientes() {
    location.href="clientes.php?action=add";
}
