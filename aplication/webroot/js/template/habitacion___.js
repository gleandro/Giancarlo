var $tableTipo = $('#bootstrap-table-habitaciones');
        ...
        'click .edit': function (e, value, row, index) {
            ...
            swal({
              ...
              $.ajax({
                type : "GET",
                url :"ajax.php",
                data: "&action=cambiarHabitacion&id="+row.id+"&nombre="+result,
                beforeSend: function(){
                },
...
$("#formAddHabitacion").submit(function(e) {
    ...
    $.ajax({
        type : "GET",
        url :"ajax.php",
        data: $("#formAddHabitacion").serialize()+'&action=registrarHabitacion',
        beforeSend: function(){
        ...
        success: function(datos){
           ...
           swal({
              title: 'Tipo de Habitacion Registrado!',
              type: 'success',
