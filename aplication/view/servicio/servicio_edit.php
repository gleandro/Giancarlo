                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"
                                               ...
                                               value="<?php echo $objServicio->__get('_nombre') ?>" 
                                        />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"
                                               ...
                                               name="alcance"
                                               number="true"
                                               value="<?php echo $objServicio->__get('_alcance') ?>"
                                        />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"
                                               ...
                                               number="true"
                                               placeholder="$"
                                               value="<?php echo $objServicio->__get('_precio') ?>"
                                        />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"
                                               ...
                                               value="<?php echo $objServicio->__get('_contacto_nombre') ?>"
                                        />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"
                                               ...
                                               value="<?php echo $objServicio->__get('_contacto_numero') ?>"
                                        />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"
                                               name="descripcion"
                                        ><?php echo $objServicio->__get('_descripcion') ?></textarea>
                                    </div>
                                </div>
                            </div> 
                        </div>
